...
public class Controller_freelancers {
        ...
        @FXML
        void btn_unblock(javafx.event.ActionEvent event) {
                try {
                        AnchorPane pane = FXMLLoader.load(getClass().getResource("Freelancers_blocked.fxml"));
                        ...
                        new Callback<TableColumn<Freelancers, Void>, TableCell<Freelancers, Void>>() {
                                ...
                                public TableCell<Freelancers, Void> call(final TableColumn<Freelancers, Void> param) {
                                        return new TableCell<Freelancers, Void>() {
                                                ...
                                                {btn.getStyleClass().add("btn_block");
                                                        btn.setOnAction(event -> {
                                                                ...
                                                                String query = "UPDATE web_signup_freelancers SET statut = 'inactive' WHERE id = " + id;
        ...
        private void loadData() {
                ResultSet rs = Connectiondb.display(
                        "SELECT `id`, `firstname`, `lastname`, `email`, `phone`, `cin`, `skill_name`, `date_created` FROM `web_signup_freelancers` WHERE statut = 'active'");
